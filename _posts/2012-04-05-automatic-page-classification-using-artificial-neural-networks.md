...
- I started by defining what I considered to be a basic set of [words](https://github.com/carvil/classify.it/blob/master/lib/techdata.rb) that are usually present in technology pages (disclaimer: please note that this is just a very basic example and therefore doesn't aim at accurately representing what is the content of a technical site);
- I also defined a [couple](https://github.com/carvil/classify.it/blob/master/lib/classifier.rb#L23) of datasets that could be representative of a technical page in terms of word counts based on the set of words defined in step 1; and a dataset representative of a webpage that is not technical, again using word counts.

After defining the datasets described above, the [sinatra](http://www.sinatrarb.com/) application (ruby DSL) will, on startup, do the following:
...
1. the probability of the page being technical;
2. and the probability of the page not being technical. 
